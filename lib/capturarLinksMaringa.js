...
function buildUrl(pageNumber) {
    return `http://www.sub100.com.br/imoveis/${args.tipo}/${args.tipo_locacao}/10-maringa-pr/de-r$${args.valorinicial}-ate-r$${args.valorfinal}/regiao-44/sub100list-resumo/pag-${pageNumber}/lista-10`;
}
